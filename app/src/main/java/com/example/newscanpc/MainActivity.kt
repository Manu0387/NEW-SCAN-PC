...
class MainActivity : AppCompatActivity() {
    ...
    private val permissionLauncher = registerForActivityResult(
        ...
        if (ok) startScan()
        else Toast.makeText(this, "Permission localisation requise pour scanner le Wi‑Fi", Toast.LENGTH_LONG).show()
    }
    ...
    private fun showFilterDialog() {
        ...
        AlertDialog.Builder(this)
            ...
            .setMessage("Préfixe à détecter (ex : prise-)")
            .setView(et)
